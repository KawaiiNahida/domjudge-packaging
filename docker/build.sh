...
URL=https://github.com/KawaiiNahida/domjudge/archive/refs/tags/${VERSION}.tar.gz
...
then
	echo "[!!] DOMjudge version ${VERSION} file not found on https://github.com/KawaiiNahida/domjudge"
	exit 1
fi
